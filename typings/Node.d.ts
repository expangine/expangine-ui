...
export declare type NodeTemplateNamedSlots = Record<string, NodeTemplateChild[] | Record<string, NodeTemplateChild[]>>;
...
export declare function getSlots(slots?: NodeTemplateSlots, name?: string, slotIndex?: number): NodeTemplateChild[];
